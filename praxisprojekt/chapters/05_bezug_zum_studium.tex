...
Den größten Bezugspunkt bildeten die Module \textit{Software Engineering 1 \& 2}. Die theoretischen Konzepte zur Softwarearchitektur waren essenziell für die Entwicklung der Game-Engine.
 Hierbei kam das Prinzip der \textbf{Separation of Concerns} (Trennung der Belange) zur Anwendung: Die strikte Trennung zwischen dem Datenmodell im Backend (PHP/Symfony), der 
...
Besonders hervorzuheben sind die \textbf{Architekturentscheidungen} im Bereich des Entwurfs:
\begin{itemize}
    \item \textbf{Entwurfsmuster:} Bei der Implementierung der Game-Engine wurden gezielt Entwurfsmuster eingesetzt, die dem Industriestandard für wiederverwendbare Software entsprechen 
    ...
    \item \textbf{Datenmodellierung:} Die Erweiterung des Datenbankschemas erforderte fundierte Kenntnisse aus dem Modul \textit{Datenbanken}. Die Normalisierung der Tabellen 
    ...
    \item \textbf{Typsicherheit:} Durch den Einsatz von TypeScript wurden Konzepte der statischen Typisierung und Schnittstellendefinition (\textit{Interfaces}) angewendet, um die 
...
fand das Wissen über \textbf{agiles Arbeiten} direkte Anwendung. <

Obwohl kein striktes Framework wie Scrum nach Lehrbuch verfolgt wurde, orientierte sich der Arbeitsalltag an agilen Prinzipien. Dies beinhaltete das \textbf{Ticketbasiertes Arbeiten}.
